...
class IrTrigger(TriggerObject):
    ...
    def __init__(self, name, pin, button_actions, targets=None, random_actions=False, allow_restart=True):
        ...
        super().__init__(name, button_actions, targets=targets, random_actions=random_actions, allow_restart=allow_restart)
